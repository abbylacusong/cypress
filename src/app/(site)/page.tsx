  ...
  return (
      <>
        <section className='overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center'>
          ...
          />
          <div className='bg-white p-[2px] mt-6 rounded-xl bg-gradient-to-r from-primary to-brand-primaryBlue sm:w-[300px] sm:mx-auto'>
            <Button 
              variant='secondary'
          ...
          <div className='md:mt-[-40px] sm:w-full w-[750px] flex justify-center items-center mt-[-20px] relative sm:ml-0 ml-[-50px]'>
            ...
            <div key={index} className="flex flex-nowrap animate-slide">
              {CLIENTS.map((client) => (
                <div key={client.alt} className="relative w-[200px] m-20 shrink-0 flex items-center">
                  <Image src={client.logo} alt={client.alt} width={200} className=' w-max-none' />
                </div>
              ))}
            </div>
          ))}
        ...
        <section className='px-4 sm:px-6 flex justify-center items-center flex-col relative'>
          ...
          <TitleSection 
            ...
            pill="Features"        
          />
          <div className='mt-10 max-w-[450px] flex justify-center items-center relative sm:ml-0 rounded-2xl border-washed-purple-300 border-opacity-10'>
            <Image
              src={Cal}
              alt="Banner"
              ...
              >
                {USERS.map((testimonial, index) => (
                  <CustomCard 
                    ...
                    className='shrink-0  rounded-xl dark:bg-gradient-to-l dark:from-border dark:to-background'
                    cardHeader={
        ...
        <section className='mt-20 px-4 sm:px-6'>
          <TitleSection
            ...
            pill="Pricing"
          />
          <div className='flex flex-col-reverse sm:flex-row gap-4 justify-center sm:justify-stretch items-center mt-10'>
            {PRICING_CARDS.map((card) => (
              <CustomCard 
                ...
                cardHeader={
                  ...
                  >
                    {card.planType === PRICING_PLANS.proplan && (
                      <>
                        <div className='hidden dark:block w-full blur-[120px] rounded-full h-32 absolute bg-brand-washedPurple/80 -z-10 top-0' />
                ...
                cardFooter = {
                  <ul className='font-normal mb-2 flex-col gap-4'>
                    <small>
